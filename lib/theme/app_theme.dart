...
/// Implements Contemporary Professional Minimalism with Trusted Financial Blue palette
/// optimized for religious financial management applications in Madagascar.
class AppTheme {
  AppTheme._();

  // Primary color palette - Trusted Financial Blue
  ...
  // Status colors
  static const Color successLight = Color(0xFF10B981); // Clear emerald
  ...
  static const Color warningDark = Color(0xFFFBBF24); // Brighter amber
  ...
  static const Color textPrimaryLight =
      Color(0xFF1E293B); // High contrast slate
  static const Color textPrimaryDark = Color(0xFFF1F5F9); // Light slate
  static const Color textSecondaryLight = Color(0xFF64748B); // Balanced gray
  static const Color textSecondaryDark = Color(0xFF94A3B8); // Lighter gray
  ...
  static const Color shadowDark = Color(0x1A000000); // 0.1 opacity
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Floating action button with subtle gradient
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      // Display styles - Inter with refined weights
  ...
  /// Get monospace text style for financial data
